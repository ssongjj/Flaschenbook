...
def fetch_api_data(isbn_list, api_keys):
    ...
    for i, isbn in enumerate(isbn_list):
        ...
        try:
            response = requests.get(url, headers=headers, params=params, timeout=0.1)
...
def save_json():
    ...
    isbn_keys = [os.environ.get("TTB_KEY"), os.environ.get("TTB_KEY2"), os.environ.get("TTB_KEY3"), os.environ.get("TTB_KEY4"), os.environ.get("TTB_KEY5"), os.environ.get("TTB_KEY6")]
